...
def main(flags):
    ...
    # Sum all loss terms.
    # total_loss = loss_stem1_2+loss_stem2_2+loss_stem3_2+loss_stemfuse +loss_seg1_2+loss_seg3_2+loss_seg5_2+loss_segfuse
    total_loss = (loss_seg1_3+loss_seg3_3+loss_seg5_3+loss_segfuse)+ (loss_stem1_3+loss_stem2_3+loss_stem3_3+loss_stemfuse)
