...
def Network(input, training):
    ...
    seg1_3_up, seg3_3_up, seg5_3_up, segfuse = Segnet(side_layer1, side_layer3, side_layer5, training)
    stem1_3_up, stem2_3_up, stem3_3_up, stemfuse = Stemnet(side_layer1, side_layer2, side_layer3, training)
...
def Segnet(seg1,seg3,seg5,training):
  ...
  ##  seg5_1_to_5_2 = conv2d_block(x=seg5_1, c=16, k=3, s=1, is_train=training, BR=True, name='seg5_1_to_5_2')
    ...
    return seg1_3_up, seg3_3_up, seg5_3_up, segfuse


def Stemnet(stem1, stem2, stem3,  training):

    stem3_1 = conv2d_block(x=stem3, c=16, k=3, s=1, is_train=training, BR=True, name='stem3_1')
    stem2_1 = conv2d_block(x=stem2, c=16, k=3, s=1, is_train=training, BR=True, name='stem2_1')
    stem1_1 = conv2d_block(x=stem1, c=16, k=3, s=1, is_train=training, BR=True, name='stem1_1')
    
    

    #stem5_2_to_stem3_1 = deconv2d(seg5_3, f_shape=[8, 8, 1, 1], output_shape=[5, 38, 50, 1], stride=4, name='stem5_2_to_stem3_1')
    #stem5_2_to_stem2_1 = deconv2d(seg5_3, f_shape=[16, 16, 1, 1], output_shape=[5, 75, 100, 1], stride=8,name='stem5_2_to_stem2_1')
    #stem5_2_to_stem1_1 = deconv2d(seg5_3, f_shape=[32, 32, 1, 1], output_shape=[5, 150, 200, 1], stride=16,name='stem5_2_to_stem1_1')
    
    
    #stem3_1 = stem3_1*stem5_2_to_stem3_1
    #stem2_1 = stem2_1*stem5_2_to_stem2_1
    #stem1_1 = stem1_1*stem5_2_to_stem1_1
